...
exclude_patterns = [u'_build', 'Thumbs.db', '.DS_Store', "README.md", "deps/*"]
...
htmlhelp_basename = 'ElkAudioOSdoc'
...
latex_documents = [
    (master_doc, 'ElkAudioOS.tex', u'Elk Audio OS Documentation',
     u'Elk', 'manual'),
]
...
man_pages = [
    (master_doc, 'elkaudioos', u'Elk Audio OS Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ElkAudioOS', u'Elk Audio OS Documentation',
     author, 'ElkAudioOS', 'One line description of project.',
     'Miscellaneous'),
]
