...
* **"portaudio_input_device_id"** - The index of the input audio device to use with PortAudio. Defaults to the system default.
* **"portaudio_output_device_id"** - The index of the output audio device to use with PortAudio. Defaults to the system default.
