...
Which OSC messages your particular configuration responds to, can be accesed bu running sushi with the `--dump-plugins` flag, as detailed in our [detailed documentation for Sushi](sushi_overview.md).